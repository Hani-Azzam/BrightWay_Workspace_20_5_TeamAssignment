######## DIR PLAN:
'''
    - add tools/CV_reader_tool.py
    - add tools/CV_section_extractor.py
    - main_assignment_06a.py

    - Bonus: add tools/CV_word_count.py
'''
    ...
    def schema(self) -> ToolSchema:
        return ToolSchema(
            ...
            description=(
                ...
                "Use this when you need to read the entire CV file. "
            ...
            parameters={
                ...
                "properties": {
                    "filename": {
                        "type": "string",
                        "description": "File name, e.g. 'CV_01.txt'",
